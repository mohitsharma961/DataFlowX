...
const ExecutionViewer = ({
  ...
  const [selectedPhase,setSelectedPhase]=useState<string|null>()
   ...
   const phaseDetails=useQuery({
    queryKey:["phaseDetaeils",selectedPhase,query.data?.status],
      ...
      <div className='flex w-full h-full'>
          ...
          {isRunning && (
            <div className='flex items-center flex-col gap-2 justify-center h-full w-full'>
              ...
              <p className='font-bold '>Run is in the progress please wait</p>
            </div>
          )}
          ...
          {!isRunning && selectedPhase && phaseDetails.data && (
            <div className='flex flex-col py-4 container gap-4 overflow-auto'>
              <div className='flex gap-2 items-center'>
                <Badge variant={'outline'} className='space-x-4'>
                  <div className='flex gap-1 items-center'>
                    <CoinsIcon size={10} className='stroke-muted-foreground'/>
                    <span>Credits</span>
                  </div>
                 ...
                 <Badge variant={'outline'} className='space-x-4'>
                  <div className='flex gap-1 items-center'>
                    <ClockIcon size={10} className='stroke-muted-foreground'/>
                    <span>Duration</span>
                  </div>
                 <span>
              ...
              <ParameterViewer title="Outputs" subTitle="Outputs generated by phase  " paramsJson={phaseDetails.data.outputs}/>
...
function ParameterViewer({title,subTitle,paramsJson}:{title:string;
  subTitle:string;
